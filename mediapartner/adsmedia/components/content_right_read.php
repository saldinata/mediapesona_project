                    ...
                    <ul class="list-posts">
						...
						<?php
							...
							$query
                              ...
                              INNER JOIN tbl_statistic_comment_news ON tbl_berita.id_berita=tbl_statistic_comment_news.id_berita
                              WHERE tbl_berita.date_publish BETWEEN ? AND ? AND tbl_berita.id_category>=6
